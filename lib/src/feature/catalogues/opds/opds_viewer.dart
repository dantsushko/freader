...
import 'package:freader/src/feature/catalogues/opds/book_detail.dart';
      ...
      onTap: () {
        ...
        if (widget.entry.authors.isNotEmpty) {
          ...
          if (catalogLink != null) {
            context.router.push(
              OpdsRoute(
                url: widget.entry.getUri(catalogLink.uri),
            ...
            children: [
                  ...
                  children: [
                    ...
                    if (widget.entry.categories.isNotEmpty)
                      Text(
                        ...
                        widget.entry.categories.map((e) => e.term).join(', '), style: TextStyle(overflow: TextOverflow.ellipsis),
                        maxLines: 3,),
              ...
              if (widget.entry.links.whereType<OpdsLinkImage>().isNotEmpty)
                Padding(
                  ...
                  child: Image.network(
                    widget.entry.getUri(widget.entry.links.whereType<OpdsLinkImage>().first.uri),
                    width: 120,
                    height: 100,
